 ...
 */
public class VolumeDialogPickerActivity extends FragmentActivity implements VolumeDialogFragmentHost {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mVolumeManager.isAvailable()) {
            ...
            final VolumeDialogFragment volumeFragment = VolumeDialogFragment.newInstance(
